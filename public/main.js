  ...
  _createClass(_default, [{
    ...
    value: function goTo() {
      ...
      if (anchor.includes('javascript')) {
        /* eslint-disable */
        var fn = anchor.replace('javascript:', '');
        eval(fn);
        /* eslint-enable */
      } else {
